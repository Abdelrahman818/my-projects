...
function scoring(userScore, pcScore) {
  let myScore = document.querySelector("div.score span.my-score");
  let score = document.querySelector("div.score span.pc-score");
  setTimeout(() => {
    myScore.innerText = userScore;
    score.innerHTML = pcScore;
  }, 1000);
}
